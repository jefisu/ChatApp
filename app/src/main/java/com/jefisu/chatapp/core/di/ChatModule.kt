...
import com.jefisu.chatapp.features_chat.domain.use_cases.ClearChat
...
import com.jefisu.chatapp.features_chat.domain.use_cases.DeleteMessage
...
object ChatModule {
    ...
    fun provideChatUseCases(
        ...
        return ChatUseCases(
            ...
            clearChat = ClearChat(repository),
